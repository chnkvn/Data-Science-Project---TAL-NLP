...
preprocessing = False #True if you want to run the preprocessing task, False if you want to skip it
clustering = True #True if you want to run the clustering task, False if you want to skip it
classification = False #True if you want to run the classification task, False if you want to skip it
...
k = 100 # number of articles to extract. 
...
cl_input_data =  'preprocessed_data.csv' #input for classification and clustering tasks
max_features = 800 #for vectorisation functions (e.g: tfidf)
