...
params_logreg = {  "vect__ngram_range" : [(1, 1), (1,2)],
            "tfidf__use_idf" : [True, False], #If true tfidf weigthing, Falso no weigthing
            "clf__C" : [5, 8,10], #penalty parameter
          }

params_mnb = {  'vect__ngram_range' : [(1, 1), (1,2)],
            "tfidf__use_idf" : [True, False], 
            "clf__alpha" : [0.001, 0.005, 0.1]}
