...
def clustering():
    ...
    km =KMeans(n_clusters=nb_labels, max_iter = 500 ).fit(X_lsa)
...
def classification():
    ...
    tfidf_vectorizer = TfidfVectorizer(max_features=cfg.max_features,
                                   use_idf=True,
                                   stop_words='english',
    ...
    print('F-Measure: {}'.format(metrics.f1_score(y_test,ypred,average='macro'))) #compute f-measure
    ...
    print('Grid best parameters: {} \n Grid best score: {}'.format(grid_search.best_score_,
